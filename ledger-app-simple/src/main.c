...
io_seproxyhal_touch_approve(const bagl_element_t *e) {
    ...
    if (G_io_apdu_buffer[2] == P1_LAST) {
        ...
        // Overwrite the first two characters of the signature (with 'x' chars) to check that the 
        // call to rust is actually working.
        G_io_apdu_buffer[1] = 'x';
        G_io_apdu_buffer[2] = test_sign();
